...
int main() {
  ...
  printf("Enter Sanjay Ashwin's private key: ");
  scanf("%lld", &privateKeyA);

  // Step 3: Compute Alice's public key (publicKey = g^privateKeyA mod p)
  publicKeyA = modExp(g, privateKeyA, p);
  printf("Sanjay Ashwin's public key: %lld\n", publicKeyA);
...
## Output:
![image](https://github.com/user-attachments/assets/d3bba37f-fbce-4d17-80f4-44b1f53e91ca)
